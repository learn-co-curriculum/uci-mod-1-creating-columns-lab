...
- Writing a column-based CSS rule set

## Introduction

Websites often use a 'column-based' layout scheme to visually deliver content.
While writing HTML and CSS for this kind of layout can be done in many different
ways, following a few simple patterns can help us achieve clean code and a
reliable column-based look.
...
This lab is a great time to practice editing CSS directly in developer tools.
